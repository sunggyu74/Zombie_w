...
public class Zombie : LivingEntity
{
    ...
    private Animator zomebieAnimator; // 애니메이터 컴포넌트
    ...
    private void Awake() {
        ...
        zomebieAnimator = GetComponent<Animator>();
    ...
    private void Update() {
        // 추적 대상의 존재 여부에 따라 다른 애미메이션 재생
        zomebieAnimator.SetBool("HasTarget", hasTarget);
    ...
    public override void Die() {
        ...
        // 사망 애니메이션 재생
        zomebieAnimator.SetTrigger("Die");
